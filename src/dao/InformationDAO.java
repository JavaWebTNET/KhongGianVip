...
public class InformationDAO {
	...
	public Information AllInformation() {
		...
		try {
			...
			String sql = "select name_res,add_res,tell,email,logo,gioithieu,tuyendung from kgvinformation";
	...
	public boolean UpdateInfo(Information info) {
		try {
			connection = ConnectDB.ConnectData();
			String sql = "update kgvinformation set name_res=?,add_res=?,tell=?,logo=?,email=?,gioithieu=?,tuyendung=?";
			pre = connection.prepareStatement(sql);
